...
Each severity layer requires different response times, from days (less severe) to minutes (most severe). That's why at _upday_ we try **not to ever exceed Severity 3**, for the sake of our sleep and nerves.
